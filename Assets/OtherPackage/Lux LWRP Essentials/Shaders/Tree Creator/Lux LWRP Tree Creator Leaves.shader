...
Shader "Lux LWRP/Nature/Tree Creator Leaves"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        //  Include base inputs and all other needed "base" includes
            #include "Includes/Lux LWRP Tree Creator Inputs.hlsl"
            #include "Includes/Lux LWRP Tree Creator Library.hlsl"
    ...
    Dependency "OptimizedShader" = "Lux LWRP/Nature/Tree Creator Leaves Optimized"
}
