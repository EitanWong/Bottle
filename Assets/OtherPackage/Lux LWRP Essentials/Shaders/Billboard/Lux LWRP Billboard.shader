Shader "Lux LWRP/Billboard"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Includes/Billboard Inputs.hlsl"
            ...
            //  Instance world position
                ...
                //  See: GetShadowCoord(VertexPositionInputs vertexInput)
                    #if SHADOWS_SCREEN
            ...
            VertexOutput ShadowPassVertex(VertexInput input)
            {
                ...
                //  Expand Billboard
                    ...
                    float3 billboardPos = (percent.x - 0.5) * billboardTangentWS;
                        ...
                        billboardPos.y += percent.y - 0.5;
                    #endif
                    float3 positionWS = TransformObjectToWorld(float4(billboardPos, 1));
                    positionWS -= _LightDirection * _ShadowOffset;
                #endif
    ...
    CustomEditor "LuxLWRPCustomBillboardShaderGUI"
}
