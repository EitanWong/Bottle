...
Shader "Lux LWRP/Glass"
{
    ...
    SubShader
    {
        ...
        //  Include base inputs and all other needed "base" includes
            #include "Includes/Lux LWRP Glass Inputs.hlsl"
        ...
        //  Vertex shader
            ...
            //  As this is a transparent shader we always need the shadowccors in worldspace!
        ...
        //  Fragment shader and functions
            ...
            //  Check depth
                ...
                //  TODO: add ortho support
                    ...
                    screenUV.xy = lerp(projectionCoord.xy/projectionCoord.w, screenUV.xy, refractionOffsetMultiplier);
                #endif
...
//  Fix screenUV for Single Pass Stereo Rendering
    ...
    CustomEditor "LuxLWRPCustomGlassShaderGUI"
}
