Shader "Lux LWRP/Particles/Simple Lit Tess"
{
// ------------------------------------------
...
// Per pixel or per vertex shadows
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Includes/Lux LWRP Particles Simple Lit Inputs.hlsl"
            #include "Includes/Lux LWRP Particles Simple Lit Forward Pass.hlsl"
            ENDHLSL
        }
    }

    Fallback "Lux LWRP/Particles/Simple Lit"
    CustomEditor "LuxLWRPParticlesCustomShaderGUI"
}
