...
//  Main Light
    ...
    half atten = NdotL * mainLight.distanceAttenuation * mainLight.shadowAttenuation;
...
//  Handle additional lights
        ...
        for (int i = 0; i < pixelLightCount; ++i) {
            ...
            NdotL = smoothstep(diffuseStep, diffuseUpper, NdotL);
            atten = NdotL * light.distanceAttenuation * light.shadowAttenuation;
...
)
{
    Lighting_half(
        ...
        diffuseStep, diffuseFalloff, specularStep, specularFalloff, shadowFalloff, colorizeMainLight, colorizeAddLights,
